...
namespace Spp.Application.Api.Controllers.V1
{
    ...
    public class QuestionnaireController : SppBaseController
    {
        private readonly QuestionnaireService _service;

        public QuestionnaireController(SppDbContext context) : base(context)
        {
        ...
        /// <param name="sessionId"></param>
        /// <returns></returns>
        //GET api/v1/questionnaires/list/5
        ...
        /// <returns></returns>
        //GET api/v1/questionnaires/entity/5
        ...
        /// <returns></returns>
        //GET api/v1/questionnaires/response/5/1
        ...
        // POST api/v1/questionnaires/update
        /// <summary>
        ...
        // POST api/v1/questionnaires/delete/5
        /// <summary>
