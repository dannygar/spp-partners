...
namespace FaceAPITrainer
{
    ...
    public sealed partial class AppShell : Page
    {
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                ...
                new NavMenuItem()
                {
                    ...
                    Label = "Recognition",
                    DestPage = typeof(RecognitionPage)
                },
                new NavMenuItem()
                {
        ...
        {
            NavMenuItem startingMenuItem = navlist.First();

            NavMenuList.SelectedItem = startingMenuItem;

            AppFrame.Navigate(startingMenuItem.DestPage, string.Empty, new Windows.UI.Xaml.Media.Animation.SuppressNavigationTransitionInfo());
        }
        ...
        public void UpdateSplitViewDisplayMode(SplitViewDisplayMode mode)
        {
            this.RootSplitView.DisplayMode = mode;
        }
        ...
        {
            RootSplitView.IsPaneOpen = TogglePaneButton.IsChecked.GetValueOrDefault();
        }
    }
}
