...
namespace Spp.Application.Services
{
    ...
    {
        public string Resolve(WorkoutExerciseData source, AthleteExerciseDto destination, string destMember,
    ...
    {
        public int Resolve(WorkoutExerciseData source, AthleteExerciseDto destination, int destMember,
            ResolutionContext context)
        {
    ...
    public class WorkoutService : SppDbService, IWorkoutService
    {
        private IDbConnection _db;

        public WorkoutService(SppDbContext context) : base(context)
        {
