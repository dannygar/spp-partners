...
namespace Spp.Application.Services
{
    ...
    public class MessageService : SppDbService, IMessageService
    {
        private IDbConnection _db;

        public MessageService(SppDbContext context) : base(context)
        {
        ...
        public async Task<bool> UpdateMessage(MessageDto messageDto)
        {
