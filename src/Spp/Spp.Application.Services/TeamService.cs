...
namespace Spp.Application.Services
{
    ...
    public class TeamService : SppDbService, ITeamService
    {
        private IDbConnection _db;

        public TeamService(SppDbContext context) : base(context)
        {
        ...
        public async Task<IEnumerable<MonthReadinessDto>> GetTeamReadiness(int id)
        {
            ...
            return teamDb.Select(rec => Mapper.Map<MonthReadinessDto>(rec)).ToList();
        }
        ...
        public async Task<IEnumerable<PlayerReadinessInformationDto>> GetPlayersReadiness(int id)
        {
            ...
            return recDb.Select(rec => Mapper.Map<PlayerReadinessInformationDto>(rec)).ToList();
        ...
        public async Task<IEnumerable<MatchInfoDto>> GetMatchHistoryInfo(int teamId)
        {
            ...
            return recDb.Select(rec => Mapper.Map<MatchInfoDto>(rec)).ToList();
        }
